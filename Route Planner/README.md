...
This project is developed in C++ using real map data and A* search to find a path between two points on a map, just as you might see in a desktop or mobile mapping application. The project is using data from the OpenStreetMap project.
